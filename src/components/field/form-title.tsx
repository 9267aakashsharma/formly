...
const FormTitle = ({ mode }: { mode: Form_Modes }) => {
  ...
  return (
    <div
      ...
      className={cn(
        "rounded-lg shadow-md flex flex-col gap-y-4 aria-selected:border-foreground aria-selected:cursor-auto aria-selected:shadow-lg aria-selected:border-t-8 aria-selected:border-t-primary",
        {
